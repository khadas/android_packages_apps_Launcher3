...
public class TaskbarActivityContext extends ContextThemeWrapper implements ActivityContext {
    ...
    public void setTaskbarWindowHeight(int height) {
        ...
        int appContentHeight = mControllers.taskbarStashController.getContentHeightToReportToApps();

        mWindowLayoutParams.height = height;
        mWindowLayoutParams.providedInternalInsets =
                Insets.of(0, height - appContentHeight, 0, 0);
